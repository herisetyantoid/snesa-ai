...
`;
  ...
  if (mode === "literasi") {
    ...
    if (d.feature === "buat") return `Buat satu paket literasi lengkap untuk murid SMP Negeri 1 Ambarawa. Tema/topik: ${d.tema || "umum"}. Kelas: ${d.kelas || "VIII"}. Jenis bacaan: ${d.jenisBacaan || "artikel informatif"}. Panjang: ${d.panjangBacaan || "sedang"}. Jumlah soal: ${d.jumlahSoal || 10}. Jenis soal: ${d.jenisSoal || "Campuran"}.
Buat terlebih dahulu bacaan orisinal yang informatif, menarik, sesuai usia, dan relevan dengan tema. Setelah itu buat soal yang benar-benar merujuk pada bacaan yang baru dibuat. Sertakan judul bacaan, teks lengkap, lalu soal bernomor. Untuk pilihan ganda gunakan 4 opsi A-D dan kunci serta pembahasan singkat. Untuk pilihan ganda kompleks/benar-salah/jika digunakan, jelaskan jawaban yang benar. Untuk esai sertakan jawaban ideal dan pedoman penskoran. Sertakan juga indikator kemampuan literasi yang diukur pada setiap soal. Jangan menggunakan fakta spesifik yang meragukan atau mengarang sumber; jika memerlukan fakta, gunakan pengetahuan umum yang aman atau tulis sumber yang dapat diverifikasi. Pastikan semua jawaban dapat ditemukan atau disimpulkan secara wajar dari bacaan.\n`;
